...
\issue{SETF-FDEFINITION-TYPE-ERROR:SIGNAL-ERROR}
\Shouldchecktype{function-name}{a \term{function name}}
\endissue{SETF-FDEFINITION-TYPE-ERROR:SIGNAL-ERROR}
...
\issue{GO-NON-EXISTENT-TAG:SIGNAL-ERROR-IN-SAFE-CODE}
The consequences are undefined
if there is no matching \param{tag} lexically visible
to the point of the \specref{go}.
\endissue{GO-NON-EXISTENT-TAG:SIGNAL-ERROR-IN-SAFE-CODE}
