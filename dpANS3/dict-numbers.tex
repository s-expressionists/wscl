...
%!!! Cross reference
\issue{FLOOR-ETC-REMAINDER-TYPE:CONTAGION}
...
\endissue{FLOOR-ETC-REMAINDER-TYPE:CONTAGION}

\issue{FFLOOR-ETC-QUOTIENT-TYPE:FLOAT-CONTAGION}
...
\endissue{FFLOOR-ETC-QUOTIENT-TYPE:FLOAT-CONTAGION}
...
\issue{INCF-DECF-VALUE-NOT-SPECIFIED:SPECIFY-VALUE-AFTER-UPDATE}
\macref{incf} and \macref{decf} are used for incrementing and
decrementing the \term{value} of \param{place}, respectively.
\endissue{INCF-DECF-VALUE-NOT-SPECIFIED:SPECIFY-VALUE-AFTER-UPDATE}
