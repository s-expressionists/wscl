...
\tablefigtwo{What Kind of Lambda Lists to Use}{Context}{Kind of Lambda List}{
 ...
 \macref{handler-case} \param{clause} specification
						   & \term{ordinary lambda list}         \cr
 \macref{restart-case} \param{clause} specification
						   & \term{ordinary lambda list}         \cr
 \specref{macrolet} local \term{macro} definition   & \term{macro lambda list}            \cr
...
\issue{DESTRUCTURING-LAMBDA-LIST-\&WHOLE-DESTRUCTURING:VARIABLE}
...
\endissue{DESTRUCTURING-LAMBDA-LIST-\&WHOLE-DESTRUCTURING:VARIABLE}
\issue{DEFMACRO-LAMBDA-LIST:TIGHTEN-DESCRIPTION}
...
Consider this example, which describes how \macref{defstruct} processes
